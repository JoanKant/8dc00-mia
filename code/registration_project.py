...
This script consists of a few functions:
    1. point_based_registration
    2. evaluate_point_based_registration
    3. calculateAvg_Distance (needed for evaluate_point_based_registration)
    4. intensity_based_registration_rigid_Corr_adapted
    5. intensity_based_registration_affine__Corr_adapted
    6. intensity_based_registration_affine_MI_adapted
    7. intensity_based_registration_demo
...
def intensity_based_registration_rigid_Corr_adapted(I_path, Im_path, mu = 0.001):
    #ADAPTED:
...
def intensity_based_registration_affine__Corr_adapted(I_path, Im_path, mu = 0.001):
    #ADAPTED:
...
def intensity_based_registration_affine_MI_adapted(I1_path, Im1_path, mu = 0.001):
    #ADAPTED:
    #Added 1)'fun2' with the original reg.affine_corr(I, Im, x), because
    #three outputs (C, Im_t, Th) are needed for the visualization. So you 
    #use the adapted function. 'fun' is the adapted rigid_corr. 
