# -*- coding: utf-8 -*-
"""
Created on Fri Sep 27 19:06:02 2019
...
if set_of_images ==1: 
    print('Registration error for pair of T1 and T1 moving: {:.2f}'.format(Reg_error1))
else: 
    print('Registration error for pair of T1 and T2: {:.2f}'.format(Reg_error1))
