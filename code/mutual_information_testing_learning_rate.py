...
##single run
mu = 0.00011
savepath_fig = path+'/\u03BC = ' + str(mu)+'final_project_affine_mutual_info_with_T1_ and_T1m.png'
savepath_sim_matrix = path +'/final_project_affine_mutual_info_T1_and_T1m_sim'+str(mu)
   

sim, fig = proj.intensity_based_registration_affine_MI_adapted(I1_path, Im1_path, mu)
plt.savefig(savepath_fig)
